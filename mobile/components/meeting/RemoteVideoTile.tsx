...
export function RemoteVideoTile({
  ...
  return (
    <Animated.View
      accessibilityLabel={`${name}, remote video`}
      style={[
        tileStyle,
        {
          opacity,
    ...
    >
      {canRenderVideo ? (
        <RTCView
          streamURL={(remote.stream as any).toURL()}
      ...
      <View
        style={[
          ...
          isScreenShare && styles.screenBadge,
        ]}
      >
        <View
          style={[
...
const styles = StyleSheet.create({
  ...
  screenBadge: {
    backgroundColor: "rgba(100, 38, 255, 0.84)",
  },
