...
import type {
  WaitingRoomAccessResponse,
  WaitingRoomAdmitAllResponse,
...
export async function emitWithAck<TResponse = unknown, TPayload = unknown>(
  ...
  return new Promise<TResponse>((resolve, reject) => {
    ...
    activeSocket.emit(
      event,
      payload,
      (response: AckResponse<TResponse>) => {
        if (settled) return;
...
export const ConfMeetingSocketCommands = {
  ...
  requestWaitingRoomAccess: (payload: {
    ...
    emitWithAck<WaitingRoomAccessResponse>(
  ...
  admitAllWaitingParticipants: (payload: {
    roomId: string;
  }) =>
    emitWithAck<WaitingRoomAdmitAllResponse>(
